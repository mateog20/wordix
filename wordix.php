...
/**
 * Calcula el puntaje total de una palabra dada.
 * @param string
 * @return int El puntaje total de la palabra.
 */
function calcularPuntajePalabra($palabra)
{
    $puntajeTotal = 0;

    for ($i = 0; $i < strlen($palabra); $i++) {
        $puntajeTotal += asignarPuntajeLetra($palabra[$i]);
    }
